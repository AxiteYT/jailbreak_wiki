  ...
  [538],
  {
    7293: (e, t, n) => {
      ...
      function a(e) {
        const { mdxAdmonitionTitle: t, rest: n } = (function (e) {
            const t = s.Children.toArray(e),
              n = t.find(
                (e) => s.isValidElement(e) && "mdxAdmonitionTitle" === e.type
              ),
              a = t.filter((e) => e !== n),
              c = n?.props.children;
            return {
              mdxAdmonitionTitle: c,
              rest:
                a.length > 0 ? (0, o.jsx)(o.Fragment, { children: a }) : null,
            };
          })(e.children),
          a = e.title ?? t;
      ...
      function d(e) {
        ...
        return (0, o.jsx)("div", {
          className: (0, c.A)(
            i.G.common.admonition,
            i.G.common.admonitionType(t),
            l.admonition,
            n
          ),
          children: s,
      ...
      function u(e) {
        ...
        return (0, o.jsxs)("div", {
          ...
          children: [
            (0, o.jsx)("span", { className: l.admonitionIcon, children: t }),
            n,
          ],
        });
      }
      function m(e) {
        let { children: t } = e;
        return t
          ? (0, o.jsx)("div", { className: l.admonitionContent, children: t })
          : null;
      }
      function h(e) {
        ...
        return (0, o.jsxs)(d, {
          ...
          className: c,
          children: [
            s || n ? (0, o.jsx)(u, { title: s, icon: n }) : null,
            (0, o.jsx)(m, { children: a }),
          ],
        });
      }
      function p(e) {
      ...
      function x(e) {
        return (0, o.jsx)(h, {
          ...f,
          ...e,
          className: (0, c.A)("alert alert--secondary", e.className),
          children: e.children,
        });
      }
      function b(e) {
      ...
      function g(e) {
        return (0, o.jsx)(h, {
          ...j,
          ...e,
          className: (0, c.A)("alert alert--success", e.className),
          children: e.children,
        });
      }
      function v(e) {
      ...
      function N(e) {
        return (0, o.jsx)(h, {
          ...y,
          ...e,
          className: (0, c.A)("alert alert--info", e.className),
          children: e.children,
        });
      }
      function A(e) {
      ...
      const E = {
        ...{
          ...
          warning: function (e) {
            return (0, o.jsx)(h, {
              ...k,
              ...e,
              className: (0, c.A)("alert alert--warning", e.className),
              children: e.children,
            });
          },
          danger: function (e) {
            return (0, o.jsx)(h, {
              ...w,
              ...e,
              className: (0, c.A)("alert alert--danger", e.className),
              children: e.children,
            });
          },
        },
        ...{
          ...
          success: (e) => (0, o.jsx)(g, { title: "success", ...e }),
          caution: function (e) {
            return (0, o.jsx)(h, {
              ...C,
              ...e,
    ...
    4336: (e, t, n) => {
      ...
      var s = n(4164),
        ...
        a = n(7559),
        c = n(8774);
      const r = { iconEdit: "iconEdit_Z9Sw" };
      var i = n(4848);
      function l(e) {
        let { className: t, ...n } = e;
        return (0, i.jsx)("svg", {
      ...
      function d(e) {
        ...
        return (0, i.jsxs)(c.A, {
          to: t,
          className: a.G.common.editThisPage,
          children: [
            (0, i.jsx)(l, {}),
            (0, i.jsx)(o.A, {
      ...
      function p(e) {
        let { lastUpdatedAt: t, lastUpdatedBy: n } = e;
        return (0, i.jsxs)("span", {
          className: a.G.common.lastUpdated,
          children: [
            (0, i.jsx)(o.A, {
              ...
              values: {
                atDate: t ? (0, i.jsx)(m, { lastUpdatedAt: t }) : "",
                byUser: n ? (0, i.jsx)(h, { lastUpdatedBy: n }) : "",
              },
      ...
      const f = { lastUpdated: "lastUpdated_JAkA" };
      function x(e) {
        let {
          className: t,
          editUrl: n,
        ...
        return (0, i.jsxs)("div", {
          className: (0, s.A)("row", t),
          children: [
            (0, i.jsx)("div", {
              className: "col",
              children: n && (0, i.jsx)(d, { editUrl: n }),
            }),
            (0, i.jsx)("div", {
              className: (0, s.A)("col", f.lastUpdated),
              children:
                (o || a) &&
                (0, i.jsx)(p, { lastUpdatedAt: o, lastUpdatedBy: a }),
            }),
          ],
        });
      }
    ...
    5533: (e, t, n) => {
      ...
      function g(e, t) {
        const n = e
          .map((e) => {
            const { start: n, end: s } = b[e];
            return `(?:${n}\\s*(${t
              .flatMap((e) =>
                [e.line, e.block?.start, e.block?.end].filter(Boolean)
              )
              .join("|")})\\s*${s})`;
          })
          .join("|");
      ...
      function v(e, t) {
        ...
        if (a && f.test(a)) {
          const e = a.match(f).groups.range;
          if (0 === o.length)
            throw new Error(
        ...
        const c = (function (e, t) {
            switch (e) {
              ...
              case "ts":
              case "typescript":
                return g(["js", "jsBlock"], t);
              case "jsx":
              case "tsx":
                return g(["js", "jsBlock", "jsx"], t);
              case "html":
                return g(["js", "jsBlock", "html"], t);
              case "python":
              case "py":
              case "bash":
                return g(["bash"], t);
          ...
          i = Object.fromEntries(
            o.map((e) => [e.className, { start: 0, range: "" }])
          ),
        ...
        for (let h = 0; h < r.length; ) {
          ...
          l[t]
            ...
            : d[t]
            ? (i[d[t]].start = h)
            : u[t] && (i[u[t]].range += `${i[u[t]].start}-${h - 1},`),
            r.splice(h, 1);
        }
        n = r.join("\n");
        const m = {};
      ...
      const y = { codeBlockContainer: "codeBlockContainer_Ckt0" };
      var N = n(4848);
      function A(e) {
        let { as: t, ...n } = e;
        const s = (function (e) {
      ...
      function B(e) {
        ...
        return (0, N.jsx)(A, {
          as: "pre",
          tabIndex: 0,
          className: (0, r.A)(k.codeBlockStandalone, "thin-scrollbar", n),
          children: (0, N.jsx)("code", {
            className: k.codeBlockLines,
            children: t,
          }),
        });
      }
      ...
      function _(e) {
        ...
        const c = o({ line: t, className: (0, r.A)(n, s && T.codeLine) }),
          i = t.map((e, t) => (0, N.jsx)("span", { ...a({ token: e }) }, t));
        return (0, N.jsxs)("span", {
          ...
          children: [
            s
              ? (0, N.jsxs)(N.Fragment, {
                  children: [
                    (0, N.jsx)("span", { className: T.codeLineNumber }),
                    (0, N.jsx)("span", {
                      className: T.codeLineContent,
                      children: i,
                    }),
                  ],
                })
      ...
      function I(e) {
        ...
        return (
          (0, s.useEffect)(() => () => window.clearTimeout(c.current), []),
          (0, N.jsx)("button", {
            type: "button",
            "aria-label": o
              ? (0, S.T)({
            ...
            className: (0, r.A)(
              ...
              n,
              z.copyButton,
              o && z.copyButtonCopied
            ),
            onClick: i,
            children: (0, N.jsxs)("span", {
              className: z.copyButtonIcons,
              "aria-hidden": "true",
              children: [
                (0, N.jsx)(U, { className: z.copyButtonIcon }),
                (0, N.jsx)(M, { className: z.copyButtonSuccessIcon }),
              ],
            }),
          })
        );
      ...
      function V(e) {
        ...
        return (0, N.jsx)("button", {
          type: "button",
          onClick: n,
          className: (0, r.A)("clean-btn", t, s && R.wordWrapButtonEnabled),
          "aria-label": o,
          title: o,
          children: (0, N.jsx)(H, {
            className: R.wordWrapButtonIcon,
            "aria-hidden": "true",
          }),
        });
      }
      function $(e) {
        ...
        const {
            ...
            const [e, t] = (0, s.useState)(!1),
              ...
              r = (0, s.useCallback)(() => {
                const { scrollWidth: e, clientWidth: t } = a.current,
                  n =
                    e > t ||
                    a.current.querySelector("code").hasAttribute("style");
                o(n);
              }, [a]);
            return (
              E(a, r),
          ...
          b =
            (function (e) {
              return e?.match(p)?.groups.title ?? "";
            })(o) || a,
          { lineClassNames: j, code: g } = v(t, {
            metastring: o,
            language: h,
            magicComments: m,
          }),
        ...
        return (0, N.jsxs)(A, {
          ...
          className: (0, r.A)(
            n,
            h && !n.includes(`language-${h}`) && `language-${h}`
          ),
          children: [
            b &&
              (0, N.jsx)("div", { className: k.codeBlockTitle, children: b }),
            (0, N.jsxs)("div", {
                ...
                (0, N.jsx)(L.f4, {
                  ...
                  children: (e) => {
                    ...
                    return (0, N.jsx)("pre", {
                      tabIndex: 0,
                      ref: x.codeBlockRef,
                      className: (0, r.A)(t, k.codeBlock, "thin-scrollbar"),
                      style: n,
                      children: (0, N.jsx)("code", {
                        className: (0, r.A)(
                          k.codeBlockLines,
                          y && k.codeBlockLinesWithNumbering
                        ),
                        children: s.map((e, t) =>
                          (0, N.jsx)(
                            _,
                ...
                (0, N.jsxs)("div", {
                  ...
                  children: [
                    (x.isEnabled || x.isCodeScrollable) &&
                      (0, N.jsx)(V, {
                        className: k.codeButton,
                        onClick: () => x.toggle(),
                        isEnabled: x.isEnabled,
                      }),
                    (0, N.jsx)(I, { className: k.codeButton, code: g }),
                  ],
                }),
              ],
            }),
      ...
      function W(e) {
        ...
        const o = (0, c.A)(),
          ...
          r = "string" == typeof a ? $ : B;
        return (0, N.jsx)(r, { ...n, children: a }, String(o));
      }
      function D(e) {
        return (0, N.jsx)("code", { ...e });
      }
      var P = n(8774);
      var q = n(3427),
        G = n(1422);
      ...
      function F(e) {
        return !!e && ("SUMMARY" === e.tagName || F(e.parentElement));
      }
      function Z(e, t) {
        return !!e && (e === t || Z(e.parentElement, t));
      }
      function J(e) {
        let { summary: t, children: n, ...o } = e;
        (0, q.A)().collectAnchor(o.id);
        const a = (0, c.A)(),
          i = (0, s.useRef)(null),
          { collapsed: l, setCollapsed: d } = (0, G.u)({
            initialState: !o.open,
          }),
          [u, m] = (0, s.useState)(o.open),
          h = s.isValidElement(t)
            ? t
            : (0, N.jsx)("summary", { children: t ?? "Details" });
        return (0, N.jsxs)("details", {
          ...o,
          ref: i,
          open: u,
          "data-collapsed": l,
          className: (0, r.A)(O.details, a && O.isBrowser, o.className),
          onMouseDown: (e) => {
            F(e.target) && e.detail > 1 && e.preventDefault();
          },
          onClick: (e) => {
            e.stopPropagation();
            const t = e.target;
            F(t) &&
              Z(t, i.current) &&
              (e.preventDefault(), l ? (d(!1), m(!0)) : d(!0));
          },
          children: [
            h,
            (0, N.jsx)(G.N, {
              ...
              children: (0, N.jsx)("div", {
                className: O.collapsibleContent,
                children: n,
              }),
            }),
          ],
      ...
      const Y = { details: "details_b_Ee" },
        K = "alert alert--info";
      function Q(e) {
        let { ...t } = e;
        return (0, N.jsx)(J, {
          ...t,
          className: (0, r.A)(K, Y.details, t.className),
        });
      }
      function X(e) {
        const t = s.Children.toArray(e.children),
          n = t.find((e) => s.isValidElement(e) && "summary" === e.type),
          o = (0, N.jsx)(N.Fragment, { children: t.filter((e) => e !== n) });
        return (0, N.jsx)(Q, { ...e, summary: n, children: o });
      }
      var ee = n(1107);
      function te(e) {
        return (0, N.jsx)(ee.A, { ...e });
      }
      const ne = { containsTaskList: "containsTaskList_mC6p" };
      function se(e) {
        if (void 0 !== e)
          return (0, r.A)(
            e,
            e?.includes("contains-task-list") && ne.containsTaskList
          );
      }
      const oe = { img: "img_ev3q" };
      var ae = n(7293),
        ce = n(418);
      const re = {
        Head: a.A,
        ...
        a: function (e) {
          return (0, N.jsx)(P.A, { ...e });
        },
        pre: function (e) {
          return (0, N.jsx)(N.Fragment, { children: e.children });
        },
        ul: function (e) {
          return (0, N.jsx)("ul", { ...e, className: se(e.className) });
        },
        li: function (e) {
          return (0, q.A)().collectAnchor(e.id), (0, N.jsx)("li", { ...e });
        },
        img: function (e) {
          return (0, N.jsx)("img", {
            decoding: "async",
            loading: "lazy",
            ...e,
            className: ((t = e.className), (0, r.A)(t, oe.img)),
          });
          var t;
        },
        h1: (e) => (0, N.jsx)(te, { as: "h1", ...e }),
        h2: (e) => (0, N.jsx)(te, { as: "h2", ...e }),
        h3: (e) => (0, N.jsx)(te, { as: "h3", ...e }),
        h4: (e) => (0, N.jsx)(te, { as: "h4", ...e }),
        h5: (e) => (0, N.jsx)(te, { as: "h5", ...e }),
        h6: (e) => (0, N.jsx)(te, { as: "h6", ...e }),
        admonition: ae.A,
        mermaid: ce.A,
      };
      function ie(e) {
        let { children: t } = e;
        return (0, N.jsx)(o.x, { components: re, children: t });
      }
    },
    6266: (e, t, n) => {
      "use strict";
