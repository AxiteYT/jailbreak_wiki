...
(self.webpackChunkjailbreak_wiki = self.webpackChunkjailbreak_wiki || []).push([
  [401],
  {
    2234: (e, t, n) => {
      ...
      function r(e) {
        ...
        return (0, o.jsx)(l.A, {
          type: "caution",
          title: (0, o.jsx)(a.Rc, {}),
          className: (0, s.A)(t, i.G.common.unlistedBanner),
          children: (0, o.jsx)(a.Uh, {}),
        });
      }
      function c(e) {
        return (0, o.jsxs)(o.Fragment, {
          children: [(0, o.jsx)(a.AE, {}), (0, o.jsx)(r, { ...e })],
        });
      }
    },
    1689: (e, t, n) => {
      ...
      function r(e) {
        ...
        return (0, o.jsx)(l.A, {
          type: "caution",
          title: (0, o.jsx)(a.Yh, {}),
          className: (0, s.A)(t, i.G.common.draftBanner),
          children: (0, o.jsx)(a.TT, {}),
        });
      }
      var c = n(2234);
      function d(e) {
        let { metadata: t } = e;
        const { unlisted: n, frontMatter: s } = t;
        return (0, o.jsxs)(o.Fragment, {
          children: [
            (n || s.unlisted) && (0, o.jsx)(c.A, {}),
            s.draft && (0, o.jsx)(r, {}),
          ],
        });
      }
    ...
    575: (e, t, n) => {
      ...
      function x() {
        const { metadata: e } = c();
        return (0, l.jsx)(b, { previous: e.previous, next: e.next });
      }
      var g = n(4586),
        f = n(8774),
        p = n(4070),
      ...
      const L = {
        unreleased: function (e) {
          ...
          return (0, l.jsx)(h.A, {
            ...
            values: {
              siteTitle: t,
              versionLabel: (0, l.jsx)("b", { children: n.label }),
            },
            children:
      ...
      function C(e) {
        const t = L[e.versionMetadata.banner];
        return (0, l.jsx)(t, { ...e });
      }
      function _(e) {
      ...
      function k(e) {
        ...
        const {
          ...
          { pluginId: a } = (0, p.vT)({ failfast: !0 }),
          { savePreferredVersionName: i } = (0, A.g1)(a),
          { latestDocSuggestion: o, latestVersionSuggestion: r } = (0, p.HW)(a),
          c = o ?? (d = r).docs.find((e) => e.id === d.mainDocId);
        var d;
        return (0, l.jsxs)("div", {
          className: (0, u.A)(
            t,
          ...
          children: [
            (0, l.jsx)("div", {
              children: (0, l.jsx)(C, { siteTitle: s, versionMetadata: n }),
            }),
            (0, l.jsx)("div", {
      ...
      function T(e) {
        ...
        const n = (0, N.r)();
        return n.banner
          ? (0, l.jsx)(k, { className: t, versionMetadata: n })
          : null;
      }
      function H(e) {
        let { className: t } = e;
      ...
      function V(e) {
        ...
        return (0, l.jsx)("button", {
          ...
          className: (0, u.A)(
            "clean-btn",
            E.tocCollapsibleButton,
            !t && E.tocCollapsibleButtonExpanded,
            n.className
          ),
          children: (0, l.jsx)(h.A, {
      ...
      function R(e) {
        ...
        const { collapsed: i, toggleCollapsed: o } = (0, B.u)({
          initialState: !0,
        });
        return (0, l.jsxs)("div", {
          className: (0, u.A)(
            O.tocCollapsible,
            !i && O.tocCollapsibleExpanded,
            n
          ),
          children: [
            (0, l.jsx)(V, { collapsed: i, onClick: o }),
            (0, l.jsx)(B.N, {
              lazy: !0,
              className: O.tocCollapsibleContent,
              collapsed: i,
      ...
      const G = { tocMobile: "tocMobile_ITEo" };
      function S() {
        ...
        return (0, l.jsx)(R, {
          ...
          className: (0, u.A)(j.G.docs.docTocMobile, G.tocMobile),
        });
      }
      var F = n(7763);
      function P() {
      ...
      function z(e) {
        ...
        return (0, l.jsxs)("div", {
          ...
          children: [
            n &&
              (0, l.jsx)("header", {
                children: (0, l.jsx)(U.A, { as: "h1", children: n }),
              }),
            (0, l.jsx)(D.A, { children: t }),
          ],
        });
      }
      var W = n(6972),
      ...
      const Q = { breadcrumbHomeIcon: "breadcrumbHomeIcon_YNFT" };
      function X() {
        const e = (0, Y.Ay)("/");
        return (0, l.jsx)("li", {
          ...
          children: (0, l.jsx)(f.A, {
            ...
            href: e,
            children: (0, l.jsx)($, { className: Q.breadcrumbHomeIcon }),
          }),
        });
      }
      const Z = { breadcrumbsContainer: "breadcrumbsContainer_Z_bl" };
      function J(e) {
        let { children: t, href: n, isLast: s } = e;
        const a = "breadcrumbs__link";
        return s
          ? (0, l.jsx)("span", { className: a, itemProp: "name", children: t })
          : n
          ? (0, l.jsx)(f.A, {
              className: a,
              href: n,
              itemProp: "item",
              children: (0, l.jsx)("span", { itemProp: "name", children: t }),
            })
          : (0, l.jsx)("span", { className: a, children: t });
      }
      function K(e) {
      ...
      function ee() {
        ...
        return e
          ? (0, l.jsx)("nav", {
              className: (0, u.A)(
                j.G.docs.docBreadcrumbs,
                Z.breadcrumbsContainer
              ),
              "aria-label": (0, h.T)({
                ...
                children: [
                  ...
                  e.map((t, n) => {
                    const s = n === e.length - 1,
                      a =
                        "category" === t.type && t.linkUnlisted
                          ? void 0
                          : t.href;
                    return (0, l.jsx)(
                      K,
      ...
      function se(e) {
        ...
        return (0, l.jsxs)("div", {
          ...
          children: [
            (0, l.jsxs)("div", {
              className: (0, u.A)("col", !n.hidden && ne.docItemCol),
              children: [
                (0, l.jsx)(te.A, { metadata: s }),
                (0, l.jsx)(T, {}),
                (0, l.jsxs)("div", {
                  className: ne.docItemContainer,
                  children: [
                    (0, l.jsxs)("article", {
                      children: [
                        (0, l.jsx)(ee, {}),
      ...
      function ae(e) {
        ...
        return (0, l.jsx)(r, {
          content: e.content,
          children: (0, l.jsxs)(a.e3, {
            className: t,
            children: [
              (0, l.jsx)(d, {}),
              (0, l.jsx)(se, { children: (0, l.jsx)(n, {}) }),
            ],
          }),
        });
      }
    ...
    7763: (e, t, n) => {
      ...
      function c(e) {
        let { className: t, ...n } = e;
        return (0, l.jsx)("div", {
          className: (0, s.A)(i.tableOfContents, "thin-scrollbar", t),
    ...
    5195: (e, t, n) => {
      ...
      function o(e) {
        ...
        return t.top === t.bottom ? o(e.parentNode) : t;
      }
      function r(e, t) {
        let { anchorTopOffset: n } = t;
        const s = e.find((e) => o(e).top >= n);
        if (s) {
          return (function (e) {
        ...
        (0, s.useEffect)(() => {
          ...
          function o() {
            const e = (function (e) {
              ...
              })({ minHeadingLevel: i, maxHeadingLevel: l }),
              c = r(o, { anchorTopOffset: n.current }),
              d = e.find(
                (e) =>
                  c &&
                  c.id ===
      ...
      function b(e) {
        ...
        const b = (0, a.p)(),
          x = c ?? b.tableOfContents.minHeadingLevel,
          g = u ?? b.tableOfContents.maxHeadingLevel,
          f = (function (e) {
            let { toc: t, minHeadingLevel: n, maxHeadingLevel: a } = e;
            return (0, s.useMemo)(
              () => l({ toc: i(t), minHeadingLevel: n, maxHeadingLevel: a }),
              [t, n, a]
            );
          })({ toc: t, minHeadingLevel: x, maxHeadingLevel: g });
        return (
          d(
            (0, s.useMemo)(() => {
              if (o && r)
          ...
          (0, m.jsx)(v, { toc: f, className: n, linkClassName: o, ...h })
        );
      }
    },
    6133: (e, t, n) => {
      ...
      var l = n(4848);
      function o(e) {
        let { permalink: t, label: n, count: o, description: r } = e;
        return (0, l.jsxs)(a.A, {
          href: t,
          title: r,
          className: (0, s.A)(i.tag, o ? i.tagWithCount : i.tagRegular),
          children: [n, o && (0, l.jsx)("span", { children: o })],
        });
      }
    },
    2053: (e, t, n) => {
      ...
      var s = n(4164),
        a = n(1312),
        i = n(6133);
      const l = { tags: "tags_jXut", tag: "tag_QGVx" };
      var o = n(4848);
      function r(e) {
        let { tags: t } = e;
        return (0, o.jsxs)(o.Fragment, {
          children: [
            ...
            (0, o.jsx)("ul", {
              className: (0, s.A)(l.tags, "padding--none", "margin-left--sm"),
              children: t.map((e) =>
                (0, o.jsx)(
                  "li",
                  { className: l.tag, children: (0, o.jsx)(i.A, { ...e }) },
                  e.permalink
                )
              ),
            }),
