    ...
    1377: (e, t, n) => {
      ...
      function h() {
        const { shown: e, scrollToTop: t } = (function (e) {
          ...
          const [n, o] = (0, a.useState)(!1),
            i = (0, a.useRef)(!1),
            { startScroll: s, cancelScroll: l } = (0, d.gk)();
          return (
            (0, d.Mq)((e, n) => {
              let { scrollY: a } = e;
              const s = n?.scrollY;
      ...
      function A(e) {
        ...
        return (0, b.jsx)("button", {
          ...
          className: (0, o.A)(
            ...
            k.collapseSidebarButton
          ),
          onClick: t,
          children: (0, b.jsx)(_, { className: k.collapseSidebarButtonIcon }),
        });
      }
      var g = n(5041),
        C = n(9532);
      ...
      function N(e) {
        ...
        const [n, o] = (0, a.useState)(null),
          i = (0, a.useMemo)(
            () => ({ expandedItem: n, setExpandedItem: o }),
            [n]
          );
        return (0, b.jsx)(T.Provider, { value: i, children: t });
      }
      var I = n(1422),
        B = n(9169),
        y = n(8774),
      ...
      function E(e) {
        ...
        const { items: u, label: m, collapsible: h, className: p, href: x } = t,
          ...
          _ = (0, l.w8)(t, i),
          k = (0, B.ys)(x, i),
          { collapsed: A, setCollapsed: g } = (0, I.u)({
            initialState: () => !!h && !_ && t.collapsed,
          }),
          { expandedItem: N, setExpandedItem: E } = (function () {
            const e = (0, a.useContext)(T);
            if (e === S) throw new C.dV("DocSidebarItemsExpandedStateProvider");
            return e;
          })(),
          M = function (e) {
            void 0 === e && (e = !A), E(e ? null : c), g(e);
          };
        return (
          (function (e) {
          ...
          })({ isActive: _, collapsed: A, updateCollapsed: M }),
          (0, a.useEffect)(() => {
            h && null != N && N !== c && j && g(!0);
          }, [h, N, c, g, j]),
          (0, b.jsxs)("li", {
            className: (0, o.A)(
              ...
              s.G.docs.docSidebarItemCategoryLevel(r),
              "menu__list-item",
            ...
            children: [
              (0, b.jsxs)("div", {
                className: (0, o.A)("menu__list-item-collapsible", {
                  "menu__list-item-collapsible--active": k,
                }),
                children: [
                  (0, b.jsx)(y.A, {
                    className: (0, o.A)("menu__link", {
      ...
      var M = n(6654),
        H = n(3186);
      const G = { menuExternalLink: "menuExternalLink_NmtK" };
      function W(e) {
        let {
          item: t,
          onItemClick: n,
        ...
        return (0, b.jsx)(
          "li",
          {
            className: (0, o.A)(
              ...
              s.G.docs.docSidebarItemLinkLevel(i),
              "menu__list-item",
              m
            ),
            children: (0, b.jsxs)(y.A, {
              className: (0, o.A)("menu__link", !x && G.menuExternalLink, {
                "menu__link--active": p,
              }),
              autoAddBaseUrl: h,
              ...
              ...c,
              children: [u, !x && (0, b.jsx)(H.A, {})],
            }),
          },
          u
        );
      }
      const P = { menuHtmlItem: "menuHtmlItem_M9Kj" };
      function R(e) {
        ...
        return (0, b.jsx)(
          "li",
          {
            className: (0, o.A)(
              s.G.docs.docSidebarItemLink,
              s.G.docs.docSidebarItemLinkLevel(n),
              l && [P.menuHtmlItem, "menu__list-item"],
              r
            ),
      ...
      function F(e) {
        let { items: t, ...n } = e;
        const a = (0, l.Y)(t, n.activePath);
        return (0, b.jsx)(N, {
          children: a.map((e, t) =>
            (0, b.jsx)(D, { item: e, index: t, ...n }, t)
          ),
        });
      }
      const U = (0, a.memo)(F),
      ...
      function Y(e) {
        ...
        return (0, b.jsx)("nav", {
          ...
          className: (0, o.A)(
            "menu thin-scrollbar",
            V.menu,
            l && V.menuWithAnnouncementBar,
            i
          ),
          children: (0, b.jsx)("ul", {
            className: (0, o.A)(s.G.docs.docSidebarMenu, "menu__list"),
            children: (0, b.jsx)(U, { items: n, activePath: t, level: 1 }),
          }),
        });
      }
      const K = "sidebar_njMd",
        z = "sidebarWithHideableNavbar_wUlq",
      ...
      function J(e) {
        ...
        return (0, b.jsxs)("div", {
          className: (0, o.A)(K, s && z, i && q),
          children: [
            s && (0, b.jsx)(v.A, { tabIndex: -1, className: O }),
            (0, b.jsx)(Y, { path: t, sidebar: n }),
            l && (0, b.jsx)(A, { onClick: a }),
          ],
        });
      }
      const Q = a.memo(J);
      ...
      function ee(e) {
        return (0, b.jsx)(X.GX, { component: $, props: e });
      }
      const te = a.memo(ee);
      function ne(e) {
        const t = (0, j.l)(),
      ...
      function le(e) {
        ...
        const { pathname: l } = (0, x.zy)(),
          [r, c] = (0, a.useState)(!1),
          d = (0, a.useCallback)(() => {
            r && c(!1), !r && (0, p.O)() && c(!0), i((e) => !e);
          }, [i, r]);
      ...
      function ce(e) {
        ...
        return (0, b.jsx)("main", {
          className: (0, o.A)(
            re.docMainContainer,
            (t || !a) && re.docMainContainerEnhanced
          ),
      ...
      const de = { docRoot: "docRoot_UBD9", docsWrapper: "docsWrapper_hBAB" };
      function ue(e) {
        let { children: t } = e;
        const n = (0, r.t)(),
          [o, i] = (0, a.useState)(!1);
      ...
      function be(e) {
        const t = (0, l.B5)(e);
        if (!t) return (0, b.jsx)(me.A, {});
        const { docElement: n, sidebarName: a, sidebarItems: c } = t;
        return (0, b.jsx)(i.e3, {
          className: (0, o.A)(s.G.page.docsDocPage),
          children: (0, b.jsx)(r.V, {
            name: a,
            items: c,
            children: (0, b.jsx)(ue, { children: n }),
          }),
        });
      }
    },
